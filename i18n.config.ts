export default defineI18nConfig(() => ({
  ...
  messages: {
    English: {
      ...
      addTeacherGroupTitle: "Add a teacher group",
      addTeacherGroupErrorTitle: "Oops... something went wrong!",
      addTeacherGroupErrorBody: "You must have atleast 1 teacher group",
      submitTeacherGroup: "Add",
